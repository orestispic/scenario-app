...
L’entrée « Commentaires » a été retirée de la navigation supérieure : les commentaires se créent depuis l’icône attachée à une sélection et restent directement accessibles dans la marge. Au survol d’un paragraphe Action ou Dialogue, l’action IA utilise uniquement l’icône étoile fournie. Une bande bleue légère couvre la largeur complète de la feuille à la hauteur du paragraphe, sans modifier le document ni intercepter les clics.

Les commentaires restent dans la marge, sans fenêtre de discussion séparée. Leur interface utilise les composants et états standards de la charte : icône d’ajout, fenêtre de création, carte, survol, bordure, actions et focus d’édition. Le jaune est strictement réservé au surlignage du passage annoté. Une nouvelle carte est repliée par défaut et ne montre que le début du commentaire sur une ligne, sans espace vertical résiduel. Un clic l’ouvre avec le texte complet et les actions autorisées ; un second clic la replie. En modification, le champ remplace le texte affiché et commence en haut de la carte. Un clic hors de la carte enregistre une modification valide puis la replie ; un conflit concurrent ou un texte vide reste ouvert pour ne perdre aucune saisie. Survoler la carte ou l’ouvrir renforce uniquement le jaune du passage annoté. La marque ProseMirror est non inclusive : une saisie à son début ou à sa fin ne peut jamais étendre le surlignage au-delà de la sélection initiale de l’utilisateur. Le placement utilise les hauteurs réelles des cartes pour éviter leur chevauchement. Les brouillons concurrents et les ancres perdues restent récupérables.
