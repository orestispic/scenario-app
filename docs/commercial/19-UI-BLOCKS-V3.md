...
Les commentaires restent dans la marge, sans fenêtre de discussion séparée. Une nouvelle carte est repliée par défaut : elle ne montre que le début du commentaire sur une ligne, sans espace vertical résiduel, et toute sa surface prend l’ambre fourni au survol. Un clic l’ouvre avec le texte complet et les actions autorisées ; un second clic la replie. En modification, le champ remplace le texte affiché et commence en haut de la carte. Le placement utilise les hauteurs réelles des cartes pour éviter leur chevauchement. Le fond des ancres utilise l’ambre fourni à 12 %, puis 22 % lorsqu’elles sont actives. Les brouillons concurrents et les ancres perdues restent récupérables.
